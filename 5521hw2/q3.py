...
folds_error_rate_1 = my_cross_val("MultiGaussClassify", boston.data, y_50, 5, diag=False)
...
folds_error_rate_2 = my_cross_val("MultiGaussClassify", boston.data, y_75, 5, diag=False)
...
folds_error_rate_3 = my_cross_val("MultiGaussClassify", digits.data, digits.target, 5, diag=False)
...
folds_error_rate_4 = my_cross_val("MultiGaussClassify", boston.data, y_50, 5, diag=True)
...
folds_error_rate_5 = my_cross_val("MultiGaussClassify", boston.data, y_75, 5, diag=True)
...
folds_error_rate_6 = my_cross_val("MultiGaussClassify", digits.data, digits.target, 5, diag=True)
...
folds_error_rate_7 = my_cross_val("LogisticRegression", boston.data, y_50, 5)
...
folds_error_rate_8 = my_cross_val("LogisticRegression", boston.data, y_75, 5)
...
folds_error_rate_9 = my_cross_val("LogisticRegression", digits.data, digits.target, 5)
